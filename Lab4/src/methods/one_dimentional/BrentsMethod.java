package methods.one_dimentional;
...
public class BrentsMethod {
    ...
    private final Dichotomy dichotomy = new Dichotomy(1e-8);
    ...
    private static boolean isBadChoose(final double a, final double b, final double x, final double minX, final double lastRange) {
